  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch('https://atkigetir-backend.onrender.com/api/products?featured=true');
        ...
        if (data.products && data.products.length > 0) {
          ...
          const allProductsResponse = await fetch('https://atkigetir-backend.onrender.com/api/products');
